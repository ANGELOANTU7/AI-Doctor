  ...
  return (
    ...
    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl mb-6 font-light lg:mb-8 md:text-lg lg:text-3xl text-semibold">AI doctor for smarter results</p>
            <Link to='/uploadz'>
            ...
            <Link to='/consult'>
            <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-400 rounded-lg hover:bg-emerald-400 focus:ring-4 focus:ring-gray-100  border-gray-700  hover:bg-slate-100  focus:ring-gray-800">
                Consult
            </a> 
            </Link>
        </div>
