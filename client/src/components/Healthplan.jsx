...
const Healthplan = () => {
      ...
      const response = await fetch('https://api.openai.com/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: `Create an exercise and diet plan in a day by day according to prescription given. I want to follow for ${numDays} days.`,
            },
            {
              role: 'user',
              content: input,
  ...
  return (
    <div className="bg-gray-100 py-8 px-4 w-screen mt-4">
      <h1 className="text-3xl font-bold mb-6 text-center">My health plan</h1>
